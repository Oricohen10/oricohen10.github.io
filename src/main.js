...
function openWin(id) {
  ...
  /* Load Press Start 2P for A11y game */
...
const TERM = [
  ...
  {h:''},
  {h:'The path looks odd on paper. To me it makes sense - both'},
  {h:'jobs are about helping people make good calls under pressure,'},
  {h:'with incomplete information. You learn to care about clarity.'},
  {h:''},
  {h:'I love this work. The thinking and the making, the people'},
  {h:'and the pixels. Shipping something real and watching it land.'},
  {h:''},
  ...
  {h:''},
  {h:'<span class="t-sec">── BACKGROUND ────────────────────────────────────────────</span>'},
  {h:''},
  {h:'<span class="t-prompt">Verint · Design Lead</span>   <span class="t-grey">2022–Present</span>'},
  {h:''},
  {h:'Started as an IC. Made it to senior in two years, then to'},
  {h:'lead. I design for contact center agents - people making'},
  {h:'hundreds of decisions per day who need software that gets'},
  {h:'out of the way. Real users. Real pressure. No room to hide.'},
  {h:''},
  {h:'Also built Verint\'s design system from the ground up - not'},
  {h:'on any roadmap, just needed doing. It runs across <span class="t-num">40+</span> products'},
  {h:'and ships to production in under <span class="t-num">60 seconds</span>.'},
  {h:''},
  {h:'I like working closely with engineers. I can hold my own in'},
  {h:'a technical conversation and I think that makes the work better.'},
  {h:''},
  {h:'<span class="t-prompt">Ori Mintz Media · UX/UI Designer</span>   <span class="t-grey">2020–2022</span>'},
  {h:''},
  {h:'Freelance websites end-to-end - discovery, design, code, QA.'},
  {h:'Good training for caring about the full picture, not just'},
  {h:'the screens you touched.'},
  {h:''},
  {h:'<span class="t-prompt">Office of the Prime Minister of Israel</span>   <span class="t-grey">2017–2020</span>'},
  {h:''},
  {h:'Classified role. High clearance. Close attention to detail.'},
  {h:'I\'ll leave it at that.'},
  {h:''},
  ...
  {h:''},
  {h:'<span class="t-sec">── CURRENTLY ─────────────────────────────────────────────</span>'},
  {h:''},
  {h:'Design Lead at <a class="tlink" href="https://verint.com" target="_blank">Verint</a>. Mostly focused on My Verint -'},
  {h:'a mobile experience for <span class="t-num">10,000+</span> contact center employees.'},
  {h:''},
  {h:'Between projects I\'m building internal tools and AI workflows'},
  {h:'for my team. I pick up whatever the problem needs - new tech,'},
  {h:'new methods. That part never stops and I don\'t want it to.'},
  {h:''},
  {h:'The question I keep coming back to, through all of it:'},
  {h:'how do people get complex work done faster without losing'},
